...
angle <-  90 - 360 * (label_m_b.2$id-0.5) /num_bar     # I substract 0.5 because the letter must have the angle of the center of the bars. Not extreme right(1) or extreme left (0)
...
#  opts(title="Top 30 Countries: With Most COVID19 Measures")
